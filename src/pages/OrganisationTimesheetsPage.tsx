...
export const OrganisationTimesheetsPage: React.FC = () => {
  ...
  const individuals = allIndividuals.filter(individual => 
    individual.OrganisationID === organisation.PK
  );
      ...
      <Box sx={{ p: 3 }}>
        <BreadcrumbNavigation
          items={[
            ...
            { label: 'Timesheets', path: `/organisation/${orgNumber}/timesheets` },
          ]}
        />
        ...
        {individuals.length === 0 && (
          <Box sx={{ 
            ...
            <TimesheetIcon sx={{ fontSize: 64, color: 'text.secondary', mb: 2 }} />
