  ...
  if (isLoading || !organisation) {
    return (
      <AppLayout>
        ...
        >
          <Typography>Loading organisation individuals...</Typography>
        </Box>
      </AppLayout>
    );
  }
        ...
        <Box sx={{ mb: 3, display: "flex", gap: 3 }}>
          ...
          >
            <Typography variant="h4" sx={{ fontWeight: 600, color: "#2e7d32" }}>
              {formatCurrency(
                individuals.reduce((sum, ind) => sum + ind.AnnualGross, 0)
              )}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              Total Payroll
          ...
          <Table>
            ...
            <TableBody>
              {individuals.map((individual) => {
                ...
                const netSalary =
                  individual.AnnualGross -
                  individual.Pension -
                  individual.NationalIns;
                ...
                return (
                  <TableRow key={individual.PK} hover>
                    ...
                    <TableCell>{formatCurrency(individual.Pension)}</TableCell>
                    <TableCell>
